...
Employees can also create leave requests, which their respective managers (leave approvers) can approve or reject. An Employee can select from a number of leave types such as Sick Leave, Casual Leave, Privilege Leave and so on. 
