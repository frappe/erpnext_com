...
* **Auto Create Assets on Purchase**: If item is company Asset, tick this checkbox if you want to auto create assets while purchasing this item through [Purchase Cycle](/docs/user/manual/en/buying/purchase-order). Check out the [Asset Module](/docs/user/manual/en/asset) to know more.
